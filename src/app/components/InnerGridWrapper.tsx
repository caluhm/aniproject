...
export default function InnerGridWrapper({ children }: ChildrenProps) {
    return (
        <div
            className="grid grid-cols-[repeat(3,_minmax(390px,_460px))] grid-rows-[repeat(auto-fill,_265px)] gap-x-[50px] gap-y-[40px] w-full min-w-0 content-center justify-center
